...
import { OptionMenu } from '../components/menu/optionMenu14';
import { Configure } from '../components/configuratorView/configurator10';

// import { Menu } from './components/menu/menu';
import { AttrList } from '../components/menu/attrList2';
...
function App() {
  ...
  return (
    <><Intro loaded={loaded}></Intro>
      <OptionMenu vertical={isLandscape} />
